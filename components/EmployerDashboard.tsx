      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 relative z-10">
        ...
        <div className="bg-white rounded-t-xl shadow-sm border-b border-gray-200 flex flex-wrap">
          <button
            ...
            className={`flex-1 py-4 px-6 text-sm font-medium text-center focus:outline-none transition-colors border-b-2 whitespace-nowrap ${
                    ...
                    <form onSubmit={handleSubmitRegistration} className="space-y-6">
                        ...
                        <div className="space-y-1.5 md:col-span-2 lg:col-span-1">
                            ...
                            <div className="relative">
                                ...
                                maxLength={21}
                                className={`w-full p-3 pr-24 border rounded-lg text-sm focus:outline-none focus:ring-1 transition-all uppercase bg-white font-mono tracking-wide ${
